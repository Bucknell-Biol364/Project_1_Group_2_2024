...
shapiro.test(Bullseye$x)
shapiro.test(Bullseye$y)

Circle <- datasaurus_dozen |>
  filter(dataset == "circle")

shapiro.test(Circle$x)
shapiro.test(Circle$y)

Dots <- datasaurus_dozen |>
  filter(dataset == "dots")

shapiro.test(Dots$x)
shapiro.test(Dots$y)

H_Lines <- datasaurus_dozen |>
  filter(dataset == "h_lines")

shapiro.test(H_Lines$x)
shapiro.test(H_Lines$y)

High_Lines <- datasaurus_dozen |>
  filter(dataset == "high_lines")

shapiro.test(High_Lines$x)
shapiro.test(High_Lines$y)

Slant_Up <- datasaurus_dozen |>
  filter(dataset == "slant_up")

shapiro.test(Slant_Up$x)
shapiro.test(Slant_Up$y)

Slant_Down <- datasaurus_dozen |>
  filter(dataset == "slant_down")

shapiro.test(Slant_Down$x)
shapiro.test(Slant_Down$y)
...
V_Lines <- datasaurus_dozen |>
  filter(dataset == "v_lines")

shapiro.test(V_Lines$x)
shapiro.test(V_Lines$y)

Wide_Lines <- datasaurus_dozen |>
  filter(dataset == "wide_lines")

shapiro.test(Wide_Lines$x)
shapiro.test(Wide_Lines$y)

X_Shape <- datasaurus_dozen |>
  filter(dataset == "x_shape")

shapiro.test(X_Shape$x)
shapiro.test(X_Shape$y)
```
