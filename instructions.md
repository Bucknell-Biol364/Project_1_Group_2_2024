...
1)  Identify which tests are appropriate for different datasets, based
    on sample size and normality
...
1)  Identify plot based on the data generated by various statistical
    tests
2)  Make aesthetic changes to code to improve readability for others.
...
What are some issues with this boxplot? 1. All x values are plotted
together instead of by dataset 2. No color
...
Which dataset do you think is the dinosaur? Write down your hypothesis.
It is okay if you do not know, you should always formulate your
hypothesis before running tests anyways.
